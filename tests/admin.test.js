...
describe("admin endpoints", () => {
  ...
  describe("admin Signup", () => {
    it("should create new user", (done) => {
      ...
      request(app)
        .post(`${process.env.API}/admin/create`)
        .send(data)
        .then((res) => {
          const body = res.body
      ...
      request(app)
        ...
        .then((res) => {
          ...
          expect(body).to.be.equal(
            "Some Fields are missing. Fill all Required Fields"
          )
          done()
        })
        .catch((err) => done(err))
  ...
  describe("admin login", () => {
    it("should login the admin", (done) => {
      ...
      request(app)
        .post(`${process.env.API}/admin/login`)
        .send(data)
        .then((res) => {
          const body = res.body
          expect(body).to.contain.property("admin_id")
    ...
    it("should say not a user", (done) => {
      ...
      request(app)
        ...
        .then((res) => {
          const body = res.body
          expect(body).to.be.equal(
            "you are not an admin please Sign in as a user"
          )
